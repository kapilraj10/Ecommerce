...
import { FiGrid, FiPackage, FiTag, FiShoppingBag, FiUsers, FiArrowLeft, FiPercent, FiImage, FiMessageSquare } from 'react-icons/fi';
...
const AdminLayout = () => {
  ...
  const links = [
    ...
    { to: '/admin/hero-banners', icon: FiImage, label: 'Hero Banners' },
